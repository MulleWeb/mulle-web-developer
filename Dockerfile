...
\
   && wget "https://github.com/mulle-cc/mulle-clang-project/releases/download/22.1.2.5/mulle-clang-22.1.2.5-bookworm-amd64.deb"  \
   && dpkg --install "mulle-clang-22.1.2.5-bookworm-amd64.deb"
