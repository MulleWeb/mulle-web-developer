...
\
   && wget "https://github.com/mulle-cc/mulle-clang-project/releases/download/22.1.2.6/mulle-clang-22.1.2.6-bookworm-amd64.deb"  \
   && dpkg --install "mulle-clang-22.1.2.6-bookworm-amd64.deb"
